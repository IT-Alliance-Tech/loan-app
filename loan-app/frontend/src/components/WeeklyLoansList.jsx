    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-start mb-6 sm:mb-8">
        ...
        <div className="flex items-center gap-2">
          <button className="flex bg-slate-50 text-slate-500 border border-slate-100 px-3 py-2 rounded-xl font-bold text-[10px] uppercase tracking-wider hover:bg-slate-100 transition-all items-center justify-center gap-1.5 shadow-sm">
            <svg
